...
public class CustomVerticalCalenderViewJava extends LinearLayout implements VerticalAdapterJava.DateSelectionListener {
    ...
    public CustomVerticalCalenderViewJava(Context context) {
        super(context);
    }

    public CustomVerticalCalenderViewJava(Context context, AttributeSet attrs) {
        super(context, attrs);
        initControl(attrs);
    }

    public CustomVerticalCalenderViewJava(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void inflate(Context context) {
        ...
        VerticalAdapterJava adapter = new VerticalAdapterJava(new LinkedHashMap<String, List<Date>>(), this);
    ...
    private void clearDateSelectionList() {
        VerticalAdapterJava.mselectedDateList.clear();
    }
    ...
    public void setRangeByDefault(Date startDateObj, Date endDateObj) {
        ...
        while (startDate <= endDate) {
            ...
            VerticalAdapterJava.mselectedDateList.add(date);
