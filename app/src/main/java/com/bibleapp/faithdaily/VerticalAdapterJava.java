...
public class VerticalAdapterJava extends RecyclerView.Adapter<VerticalAdapterJava.Holder> implements CompoundButton.OnCheckedChangeListener {
    ...
    private void setBackgroundColor(CheckBox checkBox, Calendar listCalender, int currentMonth, Calendar today) {
        ...
        if (CustomVerticalCalenderViewJava.isPreviousDateDisabled()) { // disable previous date disable flow
    ...
    private void checkBoxUnSelectedState(CheckBox checkBox, Calendar calendar, Calendar seletedDate) {
        ...
        if (calendar.get(Calendar.MONTH) == seletedDate.get(Calendar.MONTH) &&
            ...
            checkBox.setTextColor(CustomVerticalCalenderViewJava.getmCurrentDateColor()); // retain color for current date
        } else {
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean checked) {
        ...
        Calendar calendar = Calendar.getInstance();
        if (CustomVerticalCalenderViewJava.isRange()) {
